...
def account_put(id):
    ...
    return make_response(jsonify({'message': 'Account modified', 'account': account}), 200)
...
def mall_put(id):
    ...
    return make_response(jsonify({'message': 'Mall modified', 'mall': mall}), 200)
...
def unit_put(id):
    ...
    return make_response(jsonify({'message': 'Unit modified', 'unit': unit}), 200)
